...
def steer_sh_weights(
    ...
    b_n : array-like, shape (N+1,)
        ...
        :func:`~spherical_array_processing.beamforming.beam_weights_hypercardioid`).
    ...
    w : ndarray, complex128, shape ((N+1)²,)
        ...
        :func:`~spherical_array_processing.sh.matrix`).

    Examples
    --------
    >>> import numpy as np
    >>> from spherical_array_processing.types import SHBasisSpec
    >>> from spherical_array_processing.beamforming import beam_weights_hypercardioid
...
def beamform_sh(
    ...
    weights : array-like, shape (Q,)
        ...
        :func:`~spherical_array_processing.beamforming.mvdr_weights`).
