...
def direct_sht(
    ...
    y_matrix : array-like, shape (M, (N+1)²)
        SH design matrix from :func:`~spherical_array_processing.sh.matrix`.
    ...
    >>> from spherical_array_processing.sh import matrix, direct_sht
...
def inverse_sht(
    ...
    >>> from spherical_array_processing.sh import matrix
    >>> from spherical_array_processing.types import SHBasisSpec
